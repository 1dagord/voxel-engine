...
class VoxelHandler:
	def __init__(self, world):
		...
		# outputs of raycasting function
		self.chunk = None
		self.voxel_id = None
	...
	"""
		Rebuilds voxels along adjacent chunks
	"""
	...
	"""
		Determines adjacent voxels for which
		chunk mesh must be rebuilt
	...
	"""
		Implementation of Fast Voxel Traversal algorithm
